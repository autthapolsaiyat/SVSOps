...
export default function InventoryAdjustPage() {
  const [sku,setSku]=useState(""); const [qty,setQty]=useState<number>(0);
  function submit(e:React.FormEvent){e.preventDefault(); alert("Adjusted (stub)");}
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <Card className="bg-card dark:bg-[#0f172a] border border-border dark:border-[#1f2937]">
        <CardHeader><CardTitle>Inventory → Adjust</CardTitle></CardHeader>
        <CardContent>
