...
function buildQS(obj: Record<string, string | undefined>) {
      ...
      <section className="app-section overflow-visible">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center gap-2 relative z-20">
            ...
            {/* ที่มา */}
            <select
              className="border rounded-md px-2 py-1 text-sm bg-transparent shrink-0 w-[110px] relative z-10"
              value={origin}
            ...
            {/* ทีม */}
            <select
              className="border rounded-md px-2 py-1 text-sm bg-transparent shrink-0 w-[128px] sm:w-[140px] relative z-10"
              value={team}
            ...
            {/* กลุ่ม */}
            <select
              className="border rounded-md px-2 py-1 text-sm bg-transparent shrink-0 w-[160px] sm:w-[200px] relative z-10"
              value={group}
            ...
            <Button size="sm" className="ml-auto" onClick={() => nav("/products/new")}>
                      ...
                      <TableCell className="text-right">
                        <Button
                          ...
                          onClick={() => {
                            ...
                            nav(`/products/edit/${encodeURIComponent(p.sku)}${qs}`);
                          }}
                        >
